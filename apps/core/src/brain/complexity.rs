...
const TECHNICAL_TERMS: &[&str] = &[
    ...
    "algorithm", "function", "variable", "parameter", "argument", "class", "object",
    "interface", "abstract", "polymorphism", "inheritance", "encapsulation",
    "recursion", "iteration", "asynchronous", "synchronous", "concurrent",
    "thread", "mutex", "semaphore", "deadlock", "race condition",
    // Data structures
    "array", "vector", "hashmap", "tree", "graph", "queue", "stack", "heap",
    "linked list", "binary tree", "btree", "trie",
    // Architecture
    "microservice", "monolith", "api", "rest", "graphql", "websocket",
    "database", "cache", "index", "query", "transaction", "schema",
    // DevOps
    "container", "kubernetes", "docker", "ci/cd", "pipeline", "deployment",
    "infrastructure", "orchestration", "monitoring", "logging",
    // AI/ML
    "neural network", "machine learning", "deep learning", "model", "training",
    "inference", "embedding", "tokenizer", "transformer", "llm",
    // French equivalents
    "algorithme", "fonction", "paramètre", "classe", "objet", "interface",
    "récursion", "itération", "asynchrone", "synchrone", "concurrent",
    "microservice", "base de données", "requête", "transaction",
    "conteneur", "déploiement", "infrastructure", "orchestration",
    "réseau neuronal", "apprentissage automatique", "modèle", "entraînement",
];
...
impl ComplexityScorer {
    ...
    pub fn new() -> Self {
        let technical_terms: HashSet<String> = TECHNICAL_TERMS
            .iter()
